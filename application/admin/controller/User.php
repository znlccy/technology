        ...
        switch ($type) {
            case 1:
                ...
                if (empty($id)) {
                    ...
                    unset($validate_entrepreneur_rule['password']);
                    unset($validate_entrepreneur_rule['confirm_password']);
            ...
            case 2:
                ...
                if (empty($id)) {
                    ...
                    unset($validate_collaborator_rule['password']);
                    unset($validate_collaborator_rule['confirm_password']);
